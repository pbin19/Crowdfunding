    ...
    <div className="body">
      <div className="hero" style={{
        ...
        <div style={{
          ...
          <h5 style={{ fontSize: '28px', color: 'rgb(0, 158, 116)', fontWeight: 'bold' }}>
      ...
      <div className="card-container--2">
        {projects.map(project => {
          const imageUrl = `${mediaBaseUrl}${project.photo}`;
          const showProject = project.remaining_time !== "Due date ended" && project.creator != userId;
            ...
            <div className="card--2" key={project.id}>
              <a href={`/discover/${project.id}`}>
                <div className="card--display">
                  ...
                  <h2>{project.title}</h2>
                  <p>{project.creator?.username || `Creator ID: ${project.creator}`}</p>
